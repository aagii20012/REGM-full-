...
function Post({ name, url, head }) {
  ...
  let header = <CardHeader component="button" style={styleTheme.button} title="Featured posts" titleTypographyProps={{ variant: "text" }} />;
  return (
    <Card square={true} style={styleTheme.border} sx={{ mt: 1 }}>
      {head && header}
      <CardMedia component="img" height="180" image={imageUrl} alt="Paella dish" />
      <CardContent>
