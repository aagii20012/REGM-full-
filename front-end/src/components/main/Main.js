    ...
    <Container>
      <Grid container spacing={20} padding="50px 0">
        <Grid container item xs={8} spacing={5}>
          {data.getPostByLimit.paginator.postCount > 0 ? (
            data.getPostByLimit.posts.map((post, i) => {
              if (i === 6) {
                return (
                  <Grid item xs={12}>
                    <Box sx={{ height: 500 }}>
                      <BigPost name={post.category} url={post.img} title={post.title} date={post.date} person={post.person} />
                    </Box>
                  </Grid>
                );
              }
              return (
                <Grid item xs={6} key={i}>
                  <Box sx={{ height: 400 }}>
                    <Post name={post.category} url={post.img} title={post.title} date={post.date} person={post.person} />
                  </Box>
                </Grid>
              );
            })
          ...
          <Grid item xs={12}>
            <Box sx={{ mt: 5 }} justifyContent="center" display="flex" alignItems="center" flexWrap="wrap" textAlign="center">
              <div>
                <ButtonGroup size="small" aria-label="small button group" style={styleTheme.addBorder}>
                  <Pagination
          ...
          <Stack spacing={5}>
            <Box sx={{ height: 430 }}>
              <Card square={true} style={styleTheme.border}>
                <CardHeader component="button" style={styleTheme.button} title="About the author" titleTypographyProps={{ variant: "text" }} />
                <CardMedia component="img" height="180" image="img/sideLittle.jpg" alt="Paella dish" />
                <CardContent>
                  ...
                  <div style={styleTheme.bottom}>Continue Readings</div>
                </CardContent>
              </Card>
            </Box>
            <Box>
            ...
            <Box>
              <Stack spacing={10}>
                <Category />
                <Box sx={{}}>
                  <Button fullWidth sx={{ borderRadius: 0 }} style={styleTheme.buttonColor} variant="contained" size="large">
                    Social media
                  </Button>
                  <Grid container spacing={1}>
                    <Grid item xs={4}>
                      <Box sx={{ pt: 2 }} justifyContent="center" display="flex" alignItems="center" flexWrap="wrap" textAlign="center">
                ...
                <Box>
                  ...
                  <Box sx={{ mt: 2 }}>
                    <Button style={styleTheme.tag}>Business</Button>
                    <Button style={styleTheme.tag}>Freelance</Button>
                    <Button style={styleTheme.tag}>Money</Button>
                    <Button style={styleTheme.tag}>Experience</Button>
                    <Button style={styleTheme.tag}>Lifestyle</Button>
                    <Button style={styleTheme.tag}>SEO</Button>
                    <Button style={styleTheme.tag}>Wordpress</Button>
                    <Button style={styleTheme.tag}>Marketing</Button>
                    <Button style={styleTheme.tag}>UX</Button>
                    <Button style={styleTheme.tag}>Modern</Button>
                    <Button style={styleTheme.tag}>Success</Button>
                    <Button style={styleTheme.tag}>Nature</Button>
                  </Box>
                </Box>
              </Stack>
            </Box>
