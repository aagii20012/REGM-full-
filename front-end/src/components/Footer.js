...
import { Box,Stack,Link
     ,Typography,ImageList,ImageListItem, Container  } from '@mui/material'
...
function Footer() {
    ...
    return (
        <Box sx={{p:3}}>
            ...
            <ImageList  sx={{ width: "100%", maxHeigth: "300px",mt:4}} style={{overflow: "hidden"}}
             cols={6} 
            gap={20}>
                <ImageListItem key="zuragFooter">
                    <img
                        src="img/little.jpg"
                        alt="title"
                        loading="lazy"
            ...
            <Typography align='center' variant='h6' sx={{mt:8}}>
                <Stack direction="row" justifyContent="center" alignItems="center"
                    spacing={3} >
                    <Link href="#" underline="none" style={styleTheme.bars}>
                        {'Home'}
                    </Link>
                    <Link href="#" underline="none"  style={styleTheme.bars}>
                        {'Recipes'}
